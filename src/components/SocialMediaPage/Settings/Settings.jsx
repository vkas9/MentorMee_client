...
const Settings = () => {
      ...
      try {
        ...
        const updateUserCredential={
            ...
            profile: {
                ...
                contact_number:values?.contactNumber || userCredentials.profile.contact_number,
  ...
  return (
    <div className="text-white  w-full px-4 sm:px-6 lg:px-8 py-9">
      ...
      <div className={`p-4 mt-4 relative overflow-hidden bg-gradient-to-br from-gray-800 to-gray-900 z-[1] flex flex-col sm:flex-row items-center  rounded-xl py-6 gap-4 w-full sm:w-[95%] lg:max-w-[55rem]`}>
