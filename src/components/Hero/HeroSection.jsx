  ...
  return (
    <div className="h-[calc(100vh-(45px))] sm:h-[calc(100vh-(61px))] bg-transparent flex flex-col">
      <main className="flex-grow flex flex-col justify-center items-center text-center p-6">
        <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-extrabold mb-4">
...
<div className="flex flex-col items-center justify-center gap-2 sm:flex-row">
          <Link to="/signup" className="px-6 py-2 font-semibold bg-indigo-600 text-white rounded-lg shadow hover:bg-indigo-700">
            Get Started
          </Link>
          <Link to="/login" className="px-6 py-2 bg-white/10 font-semibold rounded-lg shadow hover:bg-white/20">
            Log In
          </Link>
        </div>:
