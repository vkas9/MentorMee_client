...
const ProfileDropdown = () => {
 ...
 const navigate= useNavigate()
  ...
  const handleClick=()=>{
    localStorage.setItem("active-tab", JSON.stringify({ current: "My Profile" }));
    dispatch(postAction.setActiveTab("My Profile"))
    navigate("/social-hub")
  ...
  >
    <div className="rounded-full h-[30px] w-[30px] md:h-[40px] md:w-[40px] ">
      <img
        src={userCredentials?.profile?.user_profile_image || `https://api.dicebear.com/8.x/pixel-art/svg?seed=${"User"}`}
