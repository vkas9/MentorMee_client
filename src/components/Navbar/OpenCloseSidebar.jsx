...
import SidebarPost from "../SocialMediaPage/SidebarPost/SidebarPost";
  ...
  return (
    <div className={`${className}`}>
      <Drawer open={open} onOpenChange={setOpen}>
        ...
        <DrawerContent className={` bg-gradient-to-b border-none   to-transparent`}>
          <div className="mx-auto flex items-center justify-center px-[1rem] pb-[.5rem] w-full max-w-sm ">
            <SidebarPost closeDrawer={closeDrawer} />
          </div>
        </DrawerContent>
      </Drawer>
    </div>
