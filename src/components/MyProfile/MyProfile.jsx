        ...
        <div className="flex flex-col gap-6 mt-2 text-white">
          ...
          <div className="relative flex flex-col sm:flex-row items-center bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl shadow-lg overflow-hidden p-6 sm:p-6 gap-6 w-full lg:max-w-[55rem]">
            <div
              ...
              style={{ backgroundImage: `url(${userCredentials?.profile?.user_profile_image})` }}
            ></div>
            ...
            <div className="flex flex-col items-center sm:items-start gap-2 w-full text-center sm:text-left">
              ...
              <span className="text-gray-400 text-sm sm:text-base overflow-x-auto">{userCredentials?.email}</span>
          ...
          <div className="bg-gradient-to-br lg:max-w-[55rem] relative from-gray-800 to-gray-900 p-4 sm:p-6 rounded-xl shadow-lg">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                <h3 className="text-gray-400 text-sm sm:text-base">First Name</h3>
                <p className="capitalize text-base sm:text-lg">{userCredentials?.first_name}</p>
              </div>
              <div>
                <h3 className="text-gray-400 text-sm sm:text-base">Last Name</h3>
                <p className="capitalize text-base sm:text-lg">{userCredentials?.last_name}</p>
              </div>
              <div >
                <h3 className="text-gray-400 text-sm sm:text-base">Email</h3>
                <p className="text-base sm:text-lg overflow-x-auto">{userCredentials?.email}</p>
              </div>
              <div>
                <h3 className="text-gray-400 text-sm sm:text-base">Phone Number</h3>
